package com.codingburg.checknetspeed.allfragment;
...
import com.codingburg.checknetspeed.ui.TickProgressBar;
import com.codingburg.checknetspeed.models.AdsShow;
import com.codingburg.checknetspeed.utils.ConnectionDetector;
import com.codingburg.checknetspeed.utils.GetSpeedTestHostsHandler;
import com.codingburg.checknetspeed.utils.test.HttpDownloadTest;
import com.codingburg.checknetspeed.utils.test.HttpUploadTest;
import com.codingburg.checknetspeed.utils.test.PingTest;
...
import static com.codingburg.checknetspeed.utils.LogUtils.LOGI;
import static com.codingburg.checknetspeed.utils.LogUtils.makeLogTag;
...
public class SpeedTestFragment extends Fragment {
	 ...
	 */
	public void init () {
		adsShow = new AdsShow(getActivity ());
		adsShow.initInterstitial ();
		adsShow.getInterstitialAd ().setAdListener (new AdListener () {
			@Override
			...
			public void onAdFailedToLoad (LoadAdError loadAdError) {
				...
				if (!adsShow.getInterstitialAd ().isLoading () && !adsShow.getInterstitialAd ().isLoaded ()) {
					adsShow.initInterstitial ();
				}
				if (testing) {
					testSpeed ();
		...
		tvBegin.setOnClickListener (v -> {
			testing = true;
			if (adsShow.getInterstitialAd () != null && adsShow.getInterstitialAd ().isLoaded ()) {
				adsShow.getInterstitialAd ().show ();
			} else {
